...
| documents are built out below — commissions/subscription billing and
| profile editor remain Phase 3 (docs/10-roadmap.md). Scoped to clinic
| members only via the `clinic.member` middleware
